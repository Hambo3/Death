...
class Input extends GamePad{
    static Up(){return this.IsSingle('w') || this.IsSingle('ArrowUp') || this.Joy(0,0)}
    static Down(){return this.IsSingle('s') || this.IsSingle('ArrowDown') || this.Joy(0,1)}
    static Left(){return this.IsSingle('a') || this.IsSingle('ArrowLeft') || this.Joy(0,2)}
    static Right(){return this.IsSingle('d') || this.IsSingle('ArrowRight') || this.Joy(0,3)}
    static Fire1(){return this.IsSingle('k') || this.Btn(0,0)}
    static Fire2(){return this.IsDown('l') || this.Btn(1,0)}
}
